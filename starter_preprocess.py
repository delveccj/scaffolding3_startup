...
class TextPreprocessor:
    ...
    def fetch_from_url(self, url: str) -> str:
        ...
        try:
            ...
            # Check if the URL is a .txt file by looking at the content type
            ...
            return response.text  # Return the raw text content
    ...
    def get_text_statistics(self, text: str) -> Dict:
        ...
        # Calculate average word length (total characters in words divided by total words)
        avg_word_length = sum(len(word) for word in words) / \
            total_words if total_words > 0 else 0

        # Calculate average sentence length (total words divided by total sentences)
    ...
    def create_summary(self, text: str, num_sentences: int = 3) -> str:
        ...
        # Join them back together into a summary string
